...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while (not isWordGuessed(secretWord, letterGuessed) and guessesLeft != 0):
        
        print('You have ' + str(guessesLeft) + ' guesses left.')
        
        availableLetters = getAvailableLetters(letterGuessed)
    ...
    #if you have no guesses left, then you lose, else you WIN!
    if guessesLeft == 0:
